...
ERROR_LABELS = {
    ...
    "NO_GOOGLE_ONE": "Google One 5TB offer not available for this account",
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if mode == "external_user":
        ...
        if not MAINTENANCE_MODE:
            service_line = "⚡ <b>Service:</b> Google One 5TB — 12 Months (24/7)\n"
        text = t(
            uid, "welcome",
            uid=uid,
...
async def process_deposit_claim(update: Update, context: ContextTypes.DEFAULT_TYPE, raw_txid: str):
    ...
    if raw.upper().startswith("TOOLS-"):
        ...
        admin_msg = (
            ...
            f"Waiting for API auto-detection to confirm amount.\n"
