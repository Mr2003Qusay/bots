...
EN_TEXTS = {
    ...
    "send_activate_prompt": (
        "⚡ <b>Google One 5TB — 12 Months</b>\n\n"
        "☁️ Get 5TB cloud storage for 12 months!\n"
    ...
    "activate_success": (
        "✅ <b>Google One 5TB — 12 Months Activated!</b>\n\n"
        "📧 Email: <code>{email}</code>\n"
        "🆔 Job ID: <code>{job_id}</code>\n"
        "🔗 Link: {url}\n\n"
    ...
    "deposit_pending_binance": (
        "✅ <b>Deposit Request Created!</b>\n\n"
        "🔶 Method: <b>Binance Pay</b>\n\n"
        "💰 Send EXACTLY:\n<code>{amount}</code> USDT\n\n"
        "🆔 To Binance ID:\n<code>{wallet}</code>\n\n"
        "⚠️ <b>IMPORTANT:</b>\n"
        "To confirm your payment, you MUST do <b>ONE</b> of the following:\n"
        "1️⃣ Write this <b>Note / Remark</b> when sending: <code>{code}</code>\n"
        "2️⃣ <b>OR</b> after paying, send the <b>Order ID</b> (Reference) here.\n\n"
        "📱 <i>Binance → Pay → Send → paste ID → enter amount</i>\n\n"
        "🤖 <b>Auto-detection:</b> Payments with the correct note are detected in 1-2 mins automatically!\n"
        "📨 Or manually verify by sending: <code>/claim ORDER_ID</code>\n"
        "⏰ This request expires in <b>30 minutes</b>."
    ),
    ...
    "btn_confirm": "✅ Confirm",
    "btn_cancel": "❌ Cancel",
    "btn_google_one": "⚡ Google One 5TB — 12 Months (24/7)",
    "activate_choose_service": "⚡ <b>Choose a Service:</b>",
    "btn_adm_stats": "📊 Stats",
...
HELP_SETS = {
    "main_user": {
        "en": [
            ...
            ("/activate", "Activate Google One 5TB (12 Months)."),
