...
MY_TRC20_ADDRESS = os.environ.get("MY_TRC20_ADDRESS", "TJk8xLKxUXWtbLKyCgNx96RZSHqmnaSCC1").strip()
MY_BEP20_ADDRESS = os.environ.get("MY_BEP20_ADDRESS", "0x56914b0d3694614e53c005849a34fa67c47f21f1").strip()
MY_ETH_ADDRESS = os.environ.get("MY_ETH_ADDRESS", "0x56914b0d3694614e53c005849a34fa67c47f21f1").strip()
MY_TON_ADDRESS = os.environ.get("MY_TON_ADDRESS", "UQDK5pMUSnwnfXApGus2rhLkVjehsl0vQOTUYTc58BKIWm8s").strip()
MY_BINANCE_ID = os.environ.get("MY_BINANCE_ID", "1193938302").strip()
BSCSCAN_API_KEY = os.environ.get("BSCSCAN_API_KEY", "").strip()
BINANCE_API_KEY = os.environ.get("BINANCE_API_KEY", "").strip()
BINANCE_API_SECRET = os.environ.get("BINANCE_API_SECRET", "").strip()
BINANCE_PROXY = os.environ.get("BINANCE_PROXY", "").strip()  # e.g. socks5://user:pass@host:port
...
NETWORK_AMOUNT_DECIMALS = {"TRC20": 4, "BEP20": 4, "BINANCE": 8}
NETWORK_CHAIN_DECIMALS = {"TRC20": 6, "BEP20": 18, "BINANCE": 8}
...
BACKUP_IMPORTANT_ENV = [
    ...
    "MIN_DEPOSIT", "MY_TRC20_ADDRESS", "MY_BEP20_ADDRESS", "MY_ETH_ADDRESS", "MY_TON_ADDRESS", "BSCSCAN_API_KEY",
    "BINANCE_API_KEY", "BINANCE_API_SECRET",
    "CHECKIN_REWARD", "REFERRAL_REWARD", "DB_PATH",
]

BACKUP_FILES = ["config.py", "database.py", "main.py", "pyproject.toml",
                "localization.py", "utils.py", "app_builder.py", "services/binance_pay_api.py"]
