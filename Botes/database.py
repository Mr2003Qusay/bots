...
def init_db():
    ...
    c.execute("""
        CREATE TABLE IF NOT EXISTS binance_owner_notifications (
            txid TEXT PRIMARY KEY,
            amount TEXT,
            currency TEXT,
            source TEXT,
    ...
    migrations = [
        ...
        "ALTER TABLE pending_deposits ADD COLUMN deposit_code TEXT DEFAULT ''",
        ...
        "ALTER TABLE deposits ADD COLUMN network TEXT DEFAULT ''",
    ]
    for q in migrations:
        try:
            c.execute(q)
